...
public class TestFast {
	...
	public void testupload()throws Exception{
		...
		//2.初始化加载配置文件
		ClientGlobal.init("E:\\MYCODE\\study\\javaeecode\\taotao\\taotao-manager-web\\src\\main\\resources\\resource\\fastdfs.conf");
		//3.创建trackerClient对象
	...
	public void testFastClient() throws Exception{
		FastDFSClient client = new FastDFSClient("E:\\MYCODE\\study\\javaeecode\\taotao\\taotao-manager-web\\src\\main\\resources\\resource\\fastdfs.conf");
		String uploadFile = client.uploadFile("C:\\Users\\UTT\\Desktop\\1.jpg", "jpg");
